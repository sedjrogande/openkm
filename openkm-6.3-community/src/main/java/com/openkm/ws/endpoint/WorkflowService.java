...
public class WorkflowService {
	...
	public void registerProcessDefinition(@WebParam(name = "token") String token, @WebParam(name = "pda") byte[] pda)
			throws ParseException, RepositoryException, DatabaseException, WorkflowException, IOException {
	...
	public byte[] getProcessDefinitionImage(@WebParam(name = "token") String token, @WebParam(name = "pdId") long pdId,
			@WebParam(name = "node") String node) throws RepositoryException, DatabaseException, WorkflowException {
	...
	public ProcessInstance sendProcessInstanceSignal(@WebParam(name = "token") String token,
			@WebParam(name = "piId") long piId, @WebParam(name = "transName") String transName) throws RepositoryException,
			DatabaseException, WorkflowException {
	...
	@WebMethod
	public ProcessDefinition[] findAllProcessDefinitions(@WebParam(name = "token") String token) throws RepositoryException,
			DatabaseException, WorkflowException {
	...
	@WebMethod
	public ProcessDefinition[] findLatestProcessDefinitions(@WebParam(name = "token") String token) throws RepositoryException,
			DatabaseException, WorkflowException {
	...
	public ProcessDefinition[] findAllProcessDefinitionVersions(@WebParam(name = "token") String token,
			@WebParam(name = "name") String name) throws RepositoryException, DatabaseException, WorkflowException {
	...
	public void addProcessInstanceVariable(@WebParam(name = "token") String token, @WebParam(name = "piId") long piId,
			@WebParam(name = "name") String name, @WebParam(name = "value") Object value) throws RepositoryException,
			DatabaseException, WorkflowException {
	...
	@WebMethod
	public TaskInstance[] findUserTaskInstances(@WebParam(name = "token") String token) throws RepositoryException,
			DatabaseException, WorkflowException {
	...
	@WebMethod
	public TaskInstance[] findPooledTaskInstances(@WebParam(name = "token") String token) throws RepositoryException,
			DatabaseException, WorkflowException {
	...
	public void addTaskInstanceComment(@WebParam(name = "token") String token, @WebParam(name = "tiId") long tiId,
			@WebParam(name = "message") String message) throws RepositoryException, DatabaseException, WorkflowException {
	...
	public void setTaskInstanceActorId(@WebParam(name = "token") String token, @WebParam(name = "tiId") long tiId,
			@WebParam(name = "actorId") String actorId) throws RepositoryException, DatabaseException, WorkflowException {
	...
	public void endTaskInstance(@WebParam(name = "token") String token, @WebParam(name = "tiId") long tiId,
			@WebParam(name = "transName") String transName) throws RepositoryException, DatabaseException, WorkflowException {
	...
	public void setTokenNode(@WebParam(name = "token") String token, @WebParam(name = "tkId") long tkId,
			@WebParam(name = "nodeName") String nodeName) throws RepositoryException, DatabaseException, WorkflowException {
