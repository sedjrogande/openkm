...
public class DbMailModule implements MailModule {
	...
	@Override
	public Mail getProperties(String token, String mailId) throws PathNotFoundException, RepositoryException, DatabaseException {
	...
	@Override
	@Deprecated
	public List<Mail> getChilds(String token, String fldId) throws PathNotFoundException, RepositoryException, DatabaseException {
		return getChildren(token, fldId);
	}
	
	@Override
	public List<Mail> getChildren(String token, String fldId) throws PathNotFoundException, RepositoryException, DatabaseException {
