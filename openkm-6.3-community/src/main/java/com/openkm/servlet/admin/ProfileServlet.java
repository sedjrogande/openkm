...
public class ProfileServlet extends BaseServlet {
	 ...
	 * Edit user
	 */
	private void edit(String userId, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, DatabaseException,
			NoSuchAlgorithmException, RepositoryException, ParseException, WorkflowException {
	 ...
	 * Update user
	 */
	private void delete(String userId, HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, DatabaseException,
			NoSuchAlgorithmException, RepositoryException, ParseException, WorkflowException {
	 ...
	 * Clone profile
	 */
	private void clone(String userId, HttpServletRequest request, HttpServletResponse response) throws DatabaseException, IOException, ParseException,
			RepositoryException, WorkflowException, ServletException {
	...
	private Profile getUserProfile(HttpServletRequest request) {
		...
		prf.getPrfMenu().getPrfFile().setScannerVisible(WebUtils.getBoolean(request, "prf_menu_file_scanner_visible"));
		prf.getPrfMenu().getPrfFile().setUploaderVisible(WebUtils.getBoolean(request, "prf_menu_file_uploader_visible"));
