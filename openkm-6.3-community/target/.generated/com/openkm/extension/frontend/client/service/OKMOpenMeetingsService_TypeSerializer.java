...
public class OKMOpenMeetingsService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.frontend.client.bean.extension.GWTRoom/2489528849"] = [
        @com.openkm.frontend.client.bean.extension.GWTRoom_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.extension.GWTRoom_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/openkm/frontend/client/bean/extension/GWTRoom;),
      ];
    
    result["[Lcom.openkm.frontend.client.bean.extension.GWTRoom;/1200028385"] = [
        @com.openkm.frontend.client.bean.extension.GWTRoom_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.extension.GWTRoom_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/openkm/frontend/client/bean/extension/GWTRoom;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.extension.GWTRoom::class)] = "com.openkm.frontend.client.bean.extension.GWTRoom/2489528849";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.extension.GWTRoom[]::class)] = "[Lcom.openkm.frontend.client.bean.extension.GWTRoom;/1200028385";
  ...
  public OKMOpenMeetingsService_TypeSerializer() {
