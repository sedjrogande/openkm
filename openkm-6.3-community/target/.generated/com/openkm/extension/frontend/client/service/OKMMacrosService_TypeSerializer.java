...
public class OKMMacrosService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.extension.frontend.client.bean.GWTMacros/2118865697"] = [
        @com.openkm.extension.frontend.client.bean.GWTMacros_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.extension.frontend.client.bean.GWTMacros_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/openkm/extension/frontend/client/bean/GWTMacros;),
        @com.openkm.extension.frontend.client.bean.GWTMacros_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lcom/openkm/extension/frontend/client/bean/GWTMacros;)
      ];
    
    result["[Lcom.openkm.extension.frontend.client.bean.GWTMacros;/2232345347"] = [
        @com.openkm.extension.frontend.client.bean.GWTMacros_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.extension.frontend.client.bean.GWTMacros_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/openkm/extension/frontend/client/bean/GWTMacros;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.extension.frontend.client.bean.GWTMacros::class)] = "com.openkm.extension.frontend.client.bean.GWTMacros/2118865697";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.extension.frontend.client.bean.GWTMacros[]::class)] = "[Lcom.openkm.extension.frontend.client.bean.GWTMacros;/2232345347";
  ...
  public OKMMacrosService_TypeSerializer() {
