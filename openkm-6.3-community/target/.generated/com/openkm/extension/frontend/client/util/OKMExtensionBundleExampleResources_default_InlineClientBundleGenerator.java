...
public class OKMExtensionBundleExampleResources_default_InlineClientBundleGenerator implements com.openkm.extension.frontend.client.util.OKMExtensionBundleExampleResources {
  private static OKMExtensionBundleExampleResources_default_InlineClientBundleGenerator _instance0 = new OKMExtensionBundleExampleResources_default_InlineClientBundleGenerator();
  private void boxInitializer() {
  ...
  private static class boxInitializer {
    static {
      _instance0.boxInitializer();
    }
  ...
  public com.google.gwt.resources.client.ImageResource box() {
    return boxInitializer.get();
  }
  private void generalInitializer() {
  ...
  private static class generalInitializer {
    static {
      _instance0.generalInitializer();
    }
    static com.google.gwt.resources.client.ImageResource get() {
      return general;
    }
