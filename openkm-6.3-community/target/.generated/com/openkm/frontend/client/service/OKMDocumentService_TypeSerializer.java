...
public class OKMDocumentService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.frontend.client.bean.GWTExtendedAttributes/1078807919"] = [
        ,
        ,
        @com.openkm.frontend.client.bean.GWTExtendedAttributes_FieldSerializer::serialize(Lcom/google/gwt/user/client/rpc/SerializationStreamWriter;Lcom/openkm/frontend/client/bean/GWTExtendedAttributes;)
      ];
    ...
    result["[Lcom.openkm.frontend.client.bean.GWTVersion;/384412458"] = [
        @com.openkm.frontend.client.bean.GWTVersion_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTVersion_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/openkm/frontend/client/bean/GWTVersion;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTExtendedAttributes::class)] = "com.openkm.frontend.client.bean.GWTExtendedAttributes/1078807919";
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTVersion[]::class)] = "[Lcom.openkm.frontend.client.bean.GWTVersion;/384412458";
  ...
  public OKMDocumentService_TypeSerializer() {
