...
public class OKMUINotificationService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.frontend.client.bean.GWTUINotification/1955963543"] = [
        @com.openkm.frontend.client.bean.GWTUINotification_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTUINotification_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/openkm/frontend/client/bean/GWTUINotification;),
      ];
    
    result["[Lcom.openkm.frontend.client.bean.GWTUINotification;/770541068"] = [
        @com.openkm.frontend.client.bean.GWTUINotification_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTUINotification_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/openkm/frontend/client/bean/GWTUINotification;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTUINotification::class)] = "com.openkm.frontend.client.bean.GWTUINotification/1955963543";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTUINotification[]::class)] = "[Lcom.openkm.frontend.client.bean.GWTUINotification;/770541068";
  ...
  public OKMUINotificationService_TypeSerializer() {
