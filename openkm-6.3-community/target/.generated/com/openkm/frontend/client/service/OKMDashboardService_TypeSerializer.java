...
public class OKMDashboardService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.frontend.client.bean.GWTDashboardDocumentResult/1650384741"] = [
        @com.openkm.frontend.client.bean.GWTDashboardDocumentResult_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTDashboardDocumentResult_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/openkm/frontend/client/bean/GWTDashboardDocumentResult;),
      ];
    
    result["[Lcom.openkm.frontend.client.bean.GWTDashboardDocumentResult;/1369320834"] = [
        @com.openkm.frontend.client.bean.GWTDashboardDocumentResult_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTDashboardDocumentResult_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/openkm/frontend/client/bean/GWTDashboardDocumentResult;),
      ];
    
    result["com.openkm.frontend.client.bean.GWTDashboardFolderResult/2622075398"] = [
        @com.openkm.frontend.client.bean.GWTDashboardFolderResult_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTDashboardFolderResult_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/openkm/frontend/client/bean/GWTDashboardFolderResult;),
      ];
    
    result["[Lcom.openkm.frontend.client.bean.GWTDashboardFolderResult;/2294099244"] = [
        @com.openkm.frontend.client.bean.GWTDashboardFolderResult_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTDashboardFolderResult_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/openkm/frontend/client/bean/GWTDashboardFolderResult;),
      ];
    
    result["com.openkm.frontend.client.bean.GWTDashboardMailResult/3862903639"] = [
        @com.openkm.frontend.client.bean.GWTDashboardMailResult_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTDashboardMailResult_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/openkm/frontend/client/bean/GWTDashboardMailResult;),
      ];
    
    result["[Lcom.openkm.frontend.client.bean.GWTDashboardMailResult;/3513573383"] = [
        @com.openkm.frontend.client.bean.GWTDashboardMailResult_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTDashboardMailResult_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/openkm/frontend/client/bean/GWTDashboardMailResult;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTDashboardDocumentResult::class)] = "com.openkm.frontend.client.bean.GWTDashboardDocumentResult/1650384741";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTDashboardDocumentResult[]::class)] = "[Lcom.openkm.frontend.client.bean.GWTDashboardDocumentResult;/1369320834";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTDashboardFolderResult::class)] = "com.openkm.frontend.client.bean.GWTDashboardFolderResult/2622075398";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTDashboardFolderResult[]::class)] = "[Lcom.openkm.frontend.client.bean.GWTDashboardFolderResult;/2294099244";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTDashboardMailResult::class)] = "com.openkm.frontend.client.bean.GWTDashboardMailResult/3862903639";
  ...
  public OKMDashboardService_TypeSerializer() {
