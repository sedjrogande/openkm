...
public class OKMKeyValueService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.frontend.client.bean.GWTKeyValue/1621849594"] = [
        @com.openkm.frontend.client.bean.GWTKeyValue_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTKeyValue_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/openkm/frontend/client/bean/GWTKeyValue;),
      ];
    
    result["[Lcom.openkm.frontend.client.bean.GWTKeyValue;/1205251713"] = [
        @com.openkm.frontend.client.bean.GWTKeyValue_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTKeyValue_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/openkm/frontend/client/bean/GWTKeyValue;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTKeyValue::class)] = "com.openkm.frontend.client.bean.GWTKeyValue/1621849594";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTKeyValue[]::class)] = "[Lcom.openkm.frontend.client.bean.GWTKeyValue;/1205251713";
  ...
  public OKMKeyValueService_TypeSerializer() {
