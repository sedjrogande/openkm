...
public class OKMUserConfigService_Proxy extends RemoteServiceProxy implements com.openkm.frontend.client.service.OKMUserConfigServiceAsync {
  ...
  private static final String SERIALIZATION_POLICY ="88786BA5F99D5FDAC17B1EA23BF38F9A";
  ...
  public void getUserHome(com.google.gwt.user.client.rpc.AsyncCallback callback) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("OKMUserConfigService_Proxy", "getUserHome");
    try {
  ...
  public void setUserHome(java.lang.String path, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("OKMUserConfigService_Proxy", "setUserHome");
    try {
