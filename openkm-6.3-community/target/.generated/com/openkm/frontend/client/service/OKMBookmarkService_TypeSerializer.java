...
public class OKMBookmarkService_TypeSerializer extends com.google.gwt.user.client.rpc.impl.SerializerBase {
  ...
  private static native MethodMap loadMethodsNative() /*-{
    ...
    result["com.openkm.frontend.client.bean.GWTBookmark/969162629"] = [
        @com.openkm.frontend.client.bean.GWTBookmark_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTBookmark_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;Lcom/openkm/frontend/client/bean/GWTBookmark;),
      ];
    
    result["[Lcom.openkm.frontend.client.bean.GWTBookmark;/2702109913"] = [
        @com.openkm.frontend.client.bean.GWTBookmark_Array_Rank_1_FieldSerializer::instantiate(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;),
        @com.openkm.frontend.client.bean.GWTBookmark_Array_Rank_1_FieldSerializer::deserialize(Lcom/google/gwt/user/client/rpc/SerializationStreamReader;[Lcom/openkm/frontend/client/bean/GWTBookmark;),
      ];
  ...
  private static native JsArrayString loadSignaturesNative() /*-{
    ...
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTBookmark::class)] = "com.openkm.frontend.client.bean.GWTBookmark/969162629";
    result[@com.google.gwt.core.client.impl.Impl::getHashCode(Ljava/lang/Object;)(@com.openkm.frontend.client.bean.GWTBookmark[]::class)] = "[Lcom.openkm.frontend.client.bean.GWTBookmark;/2702109913";
  ...
  public OKMBookmarkService_TypeSerializer() {
