...
public class OKMThesaurusService_Proxy extends RemoteServiceProxy implements com.openkm.frontend.client.service.OKMThesaurusServiceAsync {
  ...
  private static final String SERIALIZATION_POLICY ="99E5C9EF548AB0777801D5D035C1C64A";
  ...
  public void getKeywords(java.lang.String filter, com.google.gwt.user.client.rpc.AsyncCallback callback) {
    com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper helper = new com.google.gwt.user.client.rpc.impl.RemoteServiceProxy.ServiceHelper("OKMThesaurusService_Proxy", "getKeywords");
    try {
