...
public class GWTSuggestBox_FieldSerializer implements com.google.gwt.user.client.rpc.impl.TypeHandler {
  ...
  private static native java.lang.String getText(com.openkm.frontend.client.bean.form.GWTSuggestBox instance) /*-{
    return instance.@com.openkm.frontend.client.bean.form.GWTSuggestBox::text;
  }-*/;
  
  private static native void setText(com.openkm.frontend.client.bean.form.GWTSuggestBox instance, java.lang.String value) 
  /*-{
    instance.@com.openkm.frontend.client.bean.form.GWTSuggestBox::text = value;
  }-*/;
